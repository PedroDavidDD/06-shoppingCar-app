...
export const ToyCardItem = ({ id, image, name, species, gender, dimension, location, origin, onToyCardItem, quantity = 1, range, rarity }) => {
  return (
    <div className="card">
      <div className='cardImg'>
        <div className="cardImg__element">
          ...
          <div className='cardImg__details cardImg__details--flags' onClick={ () => onToyCardItem( { id, image, name, species, gender, dimension, origin, location, quantity, range, rarity } ) }>
