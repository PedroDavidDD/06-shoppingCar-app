...
export const ToyCardItem = ({ id, image, name, species, gender, onToyCardItem, quantity = 1 }) => {
  return (
    <div className="card">
      <div className='cardImg'>
        <div className="cardImg__element">
          <div className='cardImg__details cardImg__details--name'>
            <span className='cardImg__name'>{ name }</span>
            <span className='cardImg__name'>{ species }</span>
          </div>
          <div className='cardImg__details cardImg__details--flags' onClick={ () => onToyCardItem( { id, image, name, species, gender, quantity } ) }>
        ...
        <div className="cardImg__element cardImg__element--imagen">
          ...
          <span className='cardImg__name imagen__name imagen__name--first'>{ name }</span>
          <span className='cardImg__name imagen__name imagen__name--last'>{ species }</span>
          <span className='cardImg__name imagen__name imagen__name--lastRight'>{ gender}</span>
        </div>
      </div>
    </div>
  )
